...
class Code {
    ...
    // mapping mnemonics to binary codes
    private static final HashMap<String, String> destTable;
    private static final HashMap<String, String> compTable;
    private static final HashMap<String, String> jumpTable;
    ...
    public static String destCode(String mnemonic) {
        mnemonic = mnemonic != null && mnemonic.isEmpty() ? null : mnemonic;
    ...
    public static String jumpCode(String mnemonic) {
        mnemonic = mnemonic != null && mnemonic.isEmpty() ? null : mnemonic;        
